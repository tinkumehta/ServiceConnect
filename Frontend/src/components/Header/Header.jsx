...
function Header() {
  ...
  return (
    <header className={`flex justify-between items-center px-6 py-3 bg-white sticky top-0 z-50 border-b transition-all duration-300 ${
      isScrolled ? 'shadow-xl border-gray-200' : 'shadow-lg border-gray-100'
    }`}>
      {/* Logo */}
      <Link to="/" className="flex items-center gap-3 group">
        <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300">
          <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
          </svg>
        </div>
        <div className="flex flex-col">
          <div className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600 transition-all duration-300 group-hover:from-purple-600 group-hover:to-blue-500">
            ServiceConnect
          </div>
          <div className="text-xs text-gray-500 font-medium">Your Trusted Partner</div>
        </div>
      </Link>
      ...
      <nav className="flex items-center gap-1">
        <Link 
          to="/" 
          className="flex items-center gap-2 px-4 py-2 rounded-xl font-medium text-gray-700 hover:text-purple-600 hover:bg-purple-50 transition-all duration-300 group relative"
        >
        ...
        {user ? (
          <div className="relative" ref={dropdownRef}>
            <button 
              ...
              className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-gray-50 transition-all duration-300 border border-transparent hover:border-gray-200 ml-2"
            >
            ...
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl py-3 z-50 border border-gray-100 animate-in fade-in-0 zoom-in-95">
                ...
                <div className="py-2">
                  <Link 
                    to="/profile" 
                    className="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors duration-200 group"
                  ...
                  <button 
                    ...
                    className="flex items-center gap-3 px-4 py-3 text-red-600 hover:bg-red-50 transition-colors duration-200 w-full group"
                  >
          ...
          <div className="flex items-center gap-2 ml-4">
            <Link 
              to="/login" 
              className="px-5 py-2 text-gray-700 hover:text-purple-600 font-medium transition-colors duration-300 rounded-lg hover:bg-purple-50"
            >
              Login
            </Link>
            <Link 
              to="/register" 
              className="px-5 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-medium shadow-md hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-lg"
            >
              Sign Up
            </Link>
          </div>
